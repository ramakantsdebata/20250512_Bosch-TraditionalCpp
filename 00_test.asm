; Listing generated by Microsoft (R) Optimizing Compiler Version 19.39.33523.0 
	...
	TITLE	C:\RSD\Training\20250512_Bosch-TraditionalCpp\00_test.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_res$ = -4						; size = 4
_main	PROC
; File C:\RSD\Training\20250512_Bosch-TraditionalCpp\00_test.cpp
; Line 7
	push	ebp
	mov	ebp, esp
	push	ecx
; Line 8
	mov	DWORD PTR _res$[ebp], 100010		; 000186aaH
; Line 9
